...
public class PersonOverviewController {
	//se añade esto delante de cada uno para indicar aquellos campos y métodos que necesitan acceso al archivo fxml
	//y para que así puedan acceder (UNICAMENTE si los indicamos como privados).
	@FXML
	...
	private void initialize(){
		...
		*/
		...
		/*
			...
			obtenemos la selectedItemProperty de la tabla de personas y le añadimos un lsitener.
			esto hará que si el user selecciona una persona de la tabla el lambda expression se ejecutará, 
